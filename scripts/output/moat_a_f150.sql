...
VALUES
  ('owner_manual', 'oem_portal', NULL, NULL, 26, 8,
   ...
   'https://www.fordservicecontent.com/Ford_Content/Catalog/owner_information/2024_Ford_F-150_Owners_Manual_version_1_om_EN-US.pdf', 1,
...
VALUES
  ('owner_manual', 'oem_portal', NULL, NULL, 26, 8,
   ...
   'https://www.fordservicecontent.com/Ford_Content/Catalog/owner_information/2021-Ford-F-150-Owners-Manual-version-2_om_EN-US_10_2021.pdf', 1,
...
VALUES
  (26, NULL, 184, 59, NULL, 5.700, NULL, 'L',
   ...
   NULL, NULL, NULL, 'approved', 'claude-tracer-bullet', 'claude-tracer-bullet', NOW());
...
VALUES
  (26, NULL, 184, 62, NULL, 14.600, NULL, 'L',
   ...
   @coolant_27_old, NULL, NULL, 'approved', 'claude-tracer-bullet', 'claude-tracer-bullet', NOW());
...
VALUES
  (26, NULL, 25, 62, NULL, 13.500, NULL, 'L',
   1, 1, @doc_2024, NULL, '2023-08-01', NULL,
   @coolant_50_old, NULL, NULL, 'approved', 'claude-tracer-bullet', 'claude-tracer-bullet', NOW());
