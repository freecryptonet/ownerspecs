    ...
    <>
      ...
      <div className="shell guide-shell">
        ...
        <header className="pagehead">
          <h1>Methodology</h1>
          <p className="sub">
            ownerspecs is built from owner-manual data. Spec sheets are easy to
            find; what owners actually need — fluid capacities and grades,
        ...
        <article className="prose-body">
          ...
          <p>
            ...
            Rural Telephone Service Co.</em> (1991), facts are not
            copyrightable. What <em>is</em> copyrightable is creative
            expression: paragraph wording, custom diagrams, photo selection.
            So:
          </p>
          <ul>
          ...
          <p>
            ...
            <code> /honda/civic-sedan-x-2016-2021</code>) so the answer you
            read is for the chassis code in your driveway.
          </p>
          ...
          <ul>
            ...
            <li>Diagnostic-tool-required procedures: we mark these as such and link out to <a href="https://autodtcs.com">autodtcs.com</a> for code lookups.</li>
          </ul>

          <h2>Reporting an error</h2>
          <p>
            Found a spec you can prove wrong from your own owner manual? Open a
            GitHub issue at{" "}
            <a href="https://github.com/freecryptonet/ownerspecs/issues">
