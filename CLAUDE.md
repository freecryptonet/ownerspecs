...
**Login-walled US OEM portals also have no crawler.** **Mazda US / Toyota US / Honda US / Subaru US / Lexus US** all gate OMs behind a sign-in (`mymazda.com`, `toyota.com/owners/login`, `mygarage.honda.com`). Pattern when filling a US gen from one of these:
