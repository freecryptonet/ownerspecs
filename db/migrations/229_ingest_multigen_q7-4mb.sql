-- mig 229 — multi-gen HaynesPro ingest: Audi Q7 (4MB, 4MG)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CYMC'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_619017270; 2.0 TFSI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CYMC'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CVJA'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_619017269; 2.0 TFSI e-tron; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CVJA'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CYRB'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_317000406; 2.0 TFSI/45 TFSI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CYRB'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CUEA'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_317000402; 3.0 TDI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CUEA'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CRTE'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_319000290; 3.0 TDI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CRTE'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CZZA'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_317000405; 3.0 TDI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CZZA'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CZZB'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_318011840; 3.0 TDI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CZZB'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CVZA'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_317000404; 3.0 TDI e-tron; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CVZA'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CVMD'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_317000403; 3.0 TDI/45 TDI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CVMD'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CRTC'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_317000185; 3.0 TDI/50 TDI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CRTC'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CREC'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_317000184; 3.0 TFSI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CREC'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'DHXC'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_619013176; 45 TDI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'DHXC'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'DHXA'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_619013177; 50 TDI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'DHXA'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'DCBD'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_619017271; 55 TFSI; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'DCBD'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'DCBE'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_619028759; 55 TFSI e; Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'DCBE'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CZAC'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_319001150; SQ7 (4.0 TDI); Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CZAC'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'CZAA'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_319004623; SQ7 (4.0 TDI); Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'CZAA'));
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
...
INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'transmission_at', (SELECT id FROM engines WHERE code = 'DHVA'), 8.6, 9.09, NULL, 'SAE 75W-90', 'HaynesPro typeId t_619017272; SQ7 (4.0 V8 TDI); Automatic transmission'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'transmission_at' AND engine_id = (SELECT id FROM engines WHERE code = 'DHVA'));

INSERT INTO fluid_specs (generation_id, fluid_type, engine_id, capacity_l, capacity_qt, viscosity, spec_standard, notes)
SELECT 90, 'brake_fluid', NULL, 1, 1.06, NULL, 'VW 501 14', 'HaynesPro chassis d_312000002; Alt: DOT 4'
WHERE NOT EXISTS (SELECT 1 FROM fluid_specs WHERE generation_id = 90 AND fluid_type = 'brake_fluid' AND engine_id IS NULL);
...
WHERE fs.generation_id IN (90) AND fs.fluid_type IN ('engine_oil','coolant','brake_fluid','transmission_at','transmission_mt','transmission_dct','transmission_cvt')
