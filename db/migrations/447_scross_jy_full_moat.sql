-- 447: Moat fill for Suzuki SX4 S-Cross (JY) gen 327. Had fluids(9), fuses(84).
-- Missing: battery, torque, tyres, bulbs, svc, parts. 1.4 Boosterjet K14C (shares plug/filter
-- with the Vitara). Data from HaynesPro adjustment data + cross-checked web. Cite S-Cross OM.

SET @gen = 327;   -- s-cross-jy-suv-2013-2021
...
INSERT INTO electrical_specs (generation_id, battery_group, ah, cca) VALUES (@gen, NULL, 44, NULL);
