-- mig 218 — multi-gen HaynesPro ingest: Audi A6 (4A)
...
WHERE fs.generation_id IN (115, 152, 155, 153, 154, 160, 161, 156, 157, 158, 159) AND fs.fluid_type IN ('engine_oil','coolant')
